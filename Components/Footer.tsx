...
export default function Footer() {
  ...
  <div className="max-w-screen-xl px-4 py-16 mx-auto sm:px-6 lg:px-8">
    <div className="max-w-3xl mx-auto">
      <nav className="grid grid-cols-2  gap-4 text-center sm:grid-cols-3 lg:grid-cols-5">
        <Link href="/">
        ...
        <Link href="/Privacy-Policy">
          <a className="my-1 text-sm text-gray-700 font-medium hover:text-indigo-500 md:mx-4 md:my-0">Privacy</a>
        </Link>
      </nav>
