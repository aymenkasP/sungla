        ...
        <div className="md:flex items-center -mx-10">
          <div className="w-full md:w-1/2 px-10 mb-10 md:mb-0">
            <div className="relative ">
              <Image
                src={TheProduct[0]?.productImage.url}
                className="w-full relative z-10"
                alt={TheProduct[0]?.title}
                layout="responsive"
                priority={true}
                width={TheProduct[0]?.productImage?.width}
                height={TheProduct[0]?.productImage?.height}
              />
            ...
            <div>
              ...
              <div className="inline-block align-bottom">
                <button
                  ...
                  data-item-description={TheProduct[0]?.title}
